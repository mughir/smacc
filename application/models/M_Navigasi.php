...
class M_Navigasi extends CI_Model {
        ...
        public function utama()
        {
				...
				$fungsirole = $this->db->where("idrole",$this->session->userdata('role'))->get("fungsirole")->result_array();
				$fungsirole = array_map (function($value){
				    return $value['idfungsi'];
				} , $fungsirole);
				...
				$this->nav="<li><a href=\"".base_url()."\" class=\"halonav\">Home</a></li>";
					...
					if($this->session->userdata("role")==2){
						...
						$status=$this->m_Serbaguna->cari_narray("10000","idfungsi","sfungsi",$fungsi);
						 if($status==1 && in_array('10000',$fungsirole)){
							$this->nav.="<li class=\"dropdown\">";
								...
								$this->nav.="<ul class='dropdown-menu'>";
									...
									$this->nav.="<li><a href=\"".base_url()."masterdata/role\" class=\"halonav\">Role</a></li>";
						...
						if($status==1 && $kunci==0 && in_array('20000',$fungsirole)){
							$this->nav.="<li class=\"dropdown\">";
						...
						if($status==1 &&  $kunci==0 && in_array('30000',$fungsirole)){
							$this->nav.="<li class=\"dropdown\">";
						...
						if($status==1 &&  $kunci==0 && in_array('40000',$fungsirole)){
							$this->nav.="<li class=\"dropdown\">";
					...
					//produksi
						...
						if($status==1 && $kunci==0 && in_array('50000',$fungsirole)){
							$this->nav.="<li class=\"dropdown\">";
						...
						if($status==1 &&  $kunci==0 && in_array('60000',$fungsirole)){
							$this->nav.="<li class=\"dropdown\">";
						...
						if($status==1 &&  $kunci==0 && in_array('70000',$fungsirole)){
							$this->nav.="<li class=\"dropdown\">";
